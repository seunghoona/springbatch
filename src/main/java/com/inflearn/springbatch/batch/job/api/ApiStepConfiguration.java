...
import com.inflearn.springbatch.batch.chunk.processor.ApiItemProcessor1;
import com.inflearn.springbatch.batch.chunk.processor.ApiItemProcessor2;
import com.inflearn.springbatch.batch.chunk.processor.ApiItemProcessor3;
import com.inflearn.springbatch.batch.chunk.writer.ApiItemWriter1;
import com.inflearn.springbatch.batch.chunk.writer.ApiItemWriter2;
import com.inflearn.springbatch.batch.chunk.writer.ApiItemWriter3;
import com.inflearn.springbatch.batch.classifier.ProcessorClassifier;
import com.inflearn.springbatch.batch.classifier.WriterClassifier;
import com.inflearn.springbatch.batch.domain.ApiRequestVO;
import com.inflearn.springbatch.batch.domain.ProductVO;
import com.inflearn.springbatch.batch.partition.ProductPartitioner;
import com.inflearn.springbatch.service.APIService.ApiService1;
import com.inflearn.springbatch.service.APIService.ApiService2;
import com.inflearn.springbatch.service.APIService.ApiService3;
...
public class ApiStepConfiguration {
    ...
    public ItemReader<ProductVO> itemReader(@Value("#{stepExecutionContext['product']}") ProductVO productVO) throws Exception {
        ...
        JdbcPagingItemReader<ProductVO> reader = new JdbcPagingItemReader<ProductVO>();
